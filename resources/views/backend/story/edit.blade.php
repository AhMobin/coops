...
@section('title','Edit Story Content')
                ...
                <div class="col-md-9 col-sm-10 col-xs-12 col-md-offset-1 col-sm-offset-1">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form action="{{ url('story/'.$edit->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="story_content" id="editor" class="form-control">{!! $edit->story_content !!}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div style="float: right">
                                        <a href="{{ url('story') }}" class="btn btn-info">Back</a>
                                    </div>
                                </div>
                            </form>
