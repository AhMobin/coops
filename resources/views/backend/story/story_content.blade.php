                            ...
                            <table class="table">
                                ...
                                @foreach($story as $row)
                                    <tr>
                                        ...
                                        <td width="25%">
                                            <a href="{{ url('story/'.$row->id.'/edit') }}" class="btn btn-sm btn-info"> <i class="fa fa-edit"></i> </a>
                                            @if(!$row->status)
                                                <a href="{{ url('story/active/'.$row->id) }}" title="active now" class="btn btn-sm btn-success"> <i class="fa fa-thumbs-up"></i> </a>
                                            @else
                                                <a href="{{ url('story/inactive/'.$row->id) }}" title="inactive now" class="btn btn-sm btn-dark"> <i class="fa fa-thumbs-down"></i> </a>
                                            @endif
                                            <form action="{{ url('story/'.$row->id) }}" method="post" style="display: inline">
                                                @csrf
                                                @method('DELETE')
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="story_content" id="editor" class="form-control"></textarea>
                        </div>
